...
class BotController extends Controller
{
    ...
    public function update(Request $request, Bot $bot)
    {
        ...
        $validated = $request->validate([
            ...
            'ui_pre_chat_msg' => 'nullable|string|max:255',
            'ui_pre_chat_name_label' => 'nullable|string|max:100',
            'ui_pre_chat_phone_label' => 'nullable|string|max:100',
            'ui_pre_chat_btn_text' => 'nullable|string|max:50',
            'ui_pre_chat_error_msg' => 'nullable|string|max:255',
