...
@section('title', 'Create New Bot - SaaS AI Chatbot')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8 animate-fade-in-up">
        ...
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Create New Chatbot</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-2">Launch your AI assistant in minutes</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden animate-fade-in-up" style="animation-delay: 0.1s">
        <div class="gradient-primary px-6 py-4">
            ...
            <p class="text-white/70 text-sm mt-1">Give your bot a name to get started</p>
        </div>
        ...
        <form action="{{ route('bots.store') }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                <label for="name" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                    <i class="fas fa-tag mr-2 text-blue-500"></i>Bot Name
                </label>
                <input type="text" name="name" id="name" required
                       ...
                       placeholder="e.g., Customer Support Bot, Sales Assistant, FAQ Bot">
                @error('name')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                    <i class="fas fa-info-circle mr-1"></i>Choose a descriptive name to easily identify your bot
                </p>
            </div>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                        ...
                        <span>Configure AI model & prompts</span>
                    </div>
                    <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                        <i class="fas fa-check-circle text-green-500"></i>
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                        <i class="fas fa-check-circle text-green-500"></i>
                        <span>Customize chat widget appearance</span>
                    </div>
                    <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                        <i class="fas fa-check-circle text-green-500"></i>
                        <span>Get embed code for your website</span>
                    </div>
                    <div class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                        <i class="fas fa-check-circle text-green-500"></i>
                        <span>Monitor live chats & analytics</span>
                    </div>
                </div>
            </div>
    ...
    <div class="mt-6 bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-lg animate-fade-in-up" style="animation-delay: 0.2s">
        <div class="flex items-start gap-3">
            ...
            <div>
                <h4 class="font-semibold text-gray-900 dark:text-white">Pro Tip</h4>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    Give your bot a name that reflects its purpose. For example, "Sales Assistant" or "Customer Support Bot".
