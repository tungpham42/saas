            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <button @click="toggleTheme()"
                            class="px-3 py-2 rounded-full bg-amber-100 dark:bg-gray-800 text-amber-600 dark:text-amber-400 hover:bg-amber-200 dark:hover:bg-gray-700 transition-all">
                ...
                <div class="md:hidden flex items-center space-x-3">
                    <button @click="toggleTheme()"
                            class="px-3 py-2 rounded-full bg-amber-100 dark:bg-gray-800 text-amber-600 dark:text-amber-400">
                        <i x-show="!isDarkMode" class="fas fa-moon text-lg"></i>
                        <i x-show="isDarkMode" class="fas fa-sun text-lg"></i>
                    </button>
