...
<div class="space-y-8">
    ...
    <div class="gradient-warm rounded-2xl p-8 text-amber-900 shadow-xl animate-gentle relative overflow-hidden">
        ...
        <div class="relative z-10">
            <h1 class="text-3xl md:text-4xl font-bold mb-2">Welcome, Admin! 👑</h1>
            <p class="text-amber-800 text-lg">You're making the world a kinder place, one chat at a time.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="card-warm p-6 animate-gentle" style="animation-delay: 0.1s">
            <div class="flex justify-between items-start">
                <div>
                    <p class="text-amber-500 text-sm">Community Members</p>
            ...
            <div class="mt-4 text-sm text-amber-500">
                <i class="fas fa-heart mr-1"></i> Growing family
            </div>
        </div>
        ...
        <div class="card-warm p-6 animate-gentle" style="animation-delay: 0.2s">
            <div class="flex justify-between items-start">
                <div>
                    <p class="text-amber-500 text-sm">Bot Family</p>
            ...
            <div class="mt-4 text-sm text-amber-500">
                <i class="fas fa-smile mr-1"></i> Helping hands
            </div>
        </div>
        ...
        <div class="card-warm p-6 animate-gentle" style="animation-delay: 0.3s">
            <div class="flex justify-between items-start">
                <div>
                    <p class="text-amber-500 text-sm">Messages Shared</p>
            ...
            <div class="mt-4 text-sm text-amber-500">
                <i class="fas fa-heart mr-1"></i> Conversations
            </div>
        </div>
        ...
        <div class="card-warm p-6 animate-gentle" style="animation-delay: 0.4s">
            <div class="flex justify-between items-start">
                <div>
                    <p class="text-amber-500 text-sm">Monthly Love</p>
            ...
            <div class="mt-4 text-sm text-amber-500">
                <i class="fas fa-chart-line mr-1"></i> Supporting kindness
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="card-warm overflow-hidden animate-gentle" style="animation-delay: 0.5s">
            <div class="px-6 py-4 border-b border-amber-100 dark:border-gray-700">
                <h3 class="text-lg font-bold text-amber-800 dark:text-amber-200">Messages Over Time 📈</h3>
                <p class="text-sm text-amber-500">Last 30 days of kindness</p>
            </div>
            <div class="p-6">
        ...
        <div class="card-warm overflow-hidden animate-gentle" style="animation-delay: 0.6s">
            <div class="px-6 py-4 border-b border-amber-100 dark:border-gray-700">
                <h3 class="text-lg font-bold text-amber-800 dark:text-amber-200">Community Growth 🌱</h3>
                <p class="text-sm text-amber-500">New members joining the family</p>
            </div>
            <div class="p-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card-warm overflow-hidden animate-gentle" style="animation-delay: 0.7s">
            <div class="px-6 py-4 border-b border-amber-100 dark:border-gray-700 flex justify-between items-center">
                <h3 class="text-lg font-bold text-amber-800 dark:text-amber-200">New Family Members 🌟</h3>
                <a href="{{ route('users.index') }}" class="text-sm text-amber-500 hover:text-amber-600">View All <i class="fas fa-arrow-right ml-1"></i></a>
            </div>
                ...
                <div class="p-4 hover:bg-amber-50 dark:hover:bg-gray-800 transition-colors">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-xs text-amber-500 mt-1">{{ $user->bots_count ?? 0 }} bots</p>
                        </div>
                    </div>
                </div>
                @empty
        ...
        <div class="card-warm overflow-hidden animate-gentle" style="animation-delay: 0.8s">
            <div class="px-6 py-4 border-b border-amber-100 dark:border-gray-700 flex justify-between items-center">
                <h3 class="text-lg font-bold text-amber-800 dark:text-amber-200">New Bot Friends 🤖</h3>
                <a href="{{ route('bots.index') }}" class="text-sm text-amber-500 hover:text-amber-600">View All <i class="fas fa-arrow-right ml-1"></i></a>
            </div>
            <div class="divide-y divide-amber-100 dark:divide-gray-700">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-amber-500">Parent: {{ $bot->user->name ?? 'Unknown' }}</p>
                            </div>
                        </div>
                        <div class="text-right">
    ...
    <div class="card-warm overflow-hidden animate-gentle" style="animation-delay: 0.9s">
        <div class="px-6 py-4 border-b border-amber-100 dark:border-gray-700">
            <h3 class="text-lg font-bold text-amber-800 dark:text-amber-200">Revenue Love 💰</h3>
            <p class="text-sm text-amber-500">Supporting kindness through subscriptions</p>
        </div>
        <div class="p-6">
            <div class="space-y-4">
                <div>
                    <div class="flex justify-between text-sm mb-1">
                        <span class="text-amber-600">Free Plans (Spreaders of Joy)</span>
                ...
                <div>
                    <div class="flex justify-between text-sm mb-1">
                        <span class="text-amber-600">Paid Plans (Super Supporters)</span>
            ...
            <div class="mt-6 p-4 bg-amber-50 dark:bg-gray-800 rounded-xl text-center">
                <p class="text-sm text-amber-600">
                    ...
                    Thank you for making kindness sustainable!
                </p>
            </div>
        </div>
    </div>
